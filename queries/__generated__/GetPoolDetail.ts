...
// ====================================================
// GraphQL query operation: GetPoolDetail
// ====================================================

export interface GetPoolDetail_pool_token0 {
  __typename: "Token";
  id: string;
  symbol: string;
  name: string;
...
export interface GetPoolDetail_pool_token1 {
  __typename: "Token";
  id: string;
  symbol: string;
  name: string;
...
export interface GetPoolDetail_pool {
  __typename: "Pool";
  id: string;
  createdAtTimestamp: any;
  createdAtBlockNumber: any;
  token0: GetPoolDetail_pool_token0;
  token1: GetPoolDetail_pool_token1;
  feeTier: any;
  liquidity: any;
  sqrtPrice: any;
...
export interface GetPoolDetail {
  pool: GetPoolDetail_pool | null;
}

export interface GetPoolDetailVariables {
  poolId: string;
}
